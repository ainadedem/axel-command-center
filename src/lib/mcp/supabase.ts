/**
 * Supabase client factory for MCP tools.
 *
 * Import-safe: no env reads at module load — the MCP entry is evaluated at
 * build time and on cold start, where secrets are not available yet.
 */
...
export function unauthenticated() {
  return {
    content: [{ type: "text" as const, text: "Not authenticated — connect this MCP server with your AXEL account." }],
    isError: true,
  };
}
