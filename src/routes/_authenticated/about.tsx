...
function FeatureCard({
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-5 hover:bg-accent/40 transition">
      ...
      <p className="mt-1 t-label leading-relaxed text-muted-foreground">{description}</p>
    </div>
  );
}
...
function Section({
  ...
  return (
    <section className="space-y-4">
      <h2 className="t-title font-semibold tracking-tight text-foreground">{title}</h2>
      {children}
    </section>
  );
}
    ...
    <div className="space-y-8 p-6 max-w-4xl mx-auto">
      ...
      <div className="rounded-2xl border border-border bg-gradient-to-br from-primary/5 to-chart-2/5 p-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h2 className="t-subtitle font-semibold text-foreground">What is AXEL?</h2>
            <p className="mt-2 t-body leading-relaxed text-muted-foreground">
      ...
      <Section title="Platform Highlights">
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="flex items-start gap-3 rounded-xl border border-border bg-card p-4">
            ...
            <div>
              <h3 className="t-body font-semibold text-foreground">Multi-Currency & FX</h3>
              <p className="mt-1 t-label leading-relaxed text-muted-foreground">
          ...
          <div className="flex items-start gap-3 rounded-xl border border-border bg-card p-4">
            ...
            <div>
              <h3 className="t-body font-semibold text-foreground">Role-Based Access</h3>
              <p className="mt-1 t-label leading-relaxed text-muted-foreground">
          ...
          <div className="flex items-start gap-3 rounded-xl border border-border bg-card p-4">
            ...
            <div>
              <h3 className="t-body font-semibold text-foreground">AI Assistant — Axel AI</h3>
              <p className="mt-1 t-label leading-relaxed text-muted-foreground">
          ...
          <div className="flex items-start gap-3 rounded-xl border border-border bg-card p-4">
            ...
            <div>
              <h3 className="t-body font-semibold text-foreground">Multi-Company Groups</h3>
              <p className="mt-1 t-label leading-relaxed text-muted-foreground">
          ...
          <div className="flex items-start gap-3 rounded-xl border border-border bg-card p-4">
            ...
            <div>
              <h3 className="t-body font-semibold text-foreground">Security & Compliance</h3>
              <p className="mt-1 t-label leading-relaxed text-muted-foreground">
          ...
          <div className="flex items-start gap-3 rounded-xl border border-border bg-card p-4">
            ...
            <div>
              <h3 className="t-body font-semibold text-foreground">Cloud-Native Architecture</h3>
              <p className="mt-1 t-label leading-relaxed text-muted-foreground">
        ...
        <div className="rounded-xl border border-border bg-card p-5 space-y-4">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="t-body font-medium text-foreground">React 19</div>
                <div className="t-label text-muted-foreground">UI layer with concurrent features</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Code className="h-5 w-5 text-primary" />
              <div>
                <div className="t-body font-medium text-foreground">TypeScript</div>
                <div className="t-label text-muted-foreground">End-to-end type safety</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Zap className="h-5 w-5 text-primary" />
              <div>
                <div className="t-body font-medium text-foreground">TanStack Start</div>
                <div className="t-label text-muted-foreground">Full-stack React framework with SSR</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Server className="h-5 w-5 text-primary" />
              <div>
                <div className="t-body font-medium text-foreground">Cloud Backend</div>
                <div className="t-label text-muted-foreground">Managed PostgreSQL, Auth & Storage</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <Section title="Getting Help">
        <div className="rounded-xl border border-border bg-card p-5 space-y-3">
          ...
          <ul className="space-y-2 t-body text-muted-foreground">
      ...
      <div className="rounded-xl border border-border bg-gradient-to-r from-primary/5 via-chart-2/5 to-chart-4/5 p-5 text-center">
        <p className="t-body font-medium text-foreground">AXEL — Built with care for modern businesses</p>
